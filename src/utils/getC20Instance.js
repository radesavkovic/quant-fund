...
import contractAbi from '../../build/contracts/C20.json'
...
const getC20Instance = () => new Promise((resolve, reject) => {
  ...
  window.addEventListener('load', async() => {
    ...
    var contractAddress = '0x7a3b407076e3f39c1032d77cd28c8ceed977265a';
    var contract = await new web3.eth.contract(contractAbi.abi);
    let c20 = contract.at(contractAddress);
    ...
    //   //testnet
    //   const c20ContractAddress = (parseInt(web3.version.network, 10) === 1 ? '0x26e75307fc0c021472feb8f727839531f112f317' : '0x7A3B407076E3F39c1032d77cD28C8ceED977265A')
