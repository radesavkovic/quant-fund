      ...
      <table className="table table-bordered table-invested">
        <tbody>
          ...
          <tr>
            ...
            <td><img alt="ETH Icon" className="ccc" src="/image/eth_logo.svg"/> {ethValue}</td>
            <td><img alt="Dollar Icon" className="ccc" src="/image/dollar_logo.svg"/> {fiatValue}</td>
          </tr>
        </tbody>
      </table>
    </form>
              ...
              <table className="table table-bordered table-invested">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img alt="ETH Icon" className="ccc" src="/image/eth_logo.svg"/></td>
                    <td><img alt="Dollar Icon" className="ccc" src="/image/dollar_logo.svg"/></td>
                  </tr>
                </tbody>
              </table>
            </div>
