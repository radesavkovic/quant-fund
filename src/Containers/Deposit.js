...
var ethereum_address = require('ethereum-address'); // TODO:: Take this library out and place in path since cannot be minified
      ...
      <table className="table table-bordered table-invested">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <img alt="ETH Icon" className="ccc" src="/image/eth_logo.svg"/> {ethValue}</td><td><img alt="Dollar Icon" className="ccc" src="/image/dollar_logo.svg"/> {fiatValue}
            </td>
          </tr>
        </tbody>
      </table>
